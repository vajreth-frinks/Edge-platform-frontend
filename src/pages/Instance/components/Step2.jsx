...
const Step2 = (props) => {
  return (
    <div className="flex flex-col gap-4 md:gap-5 lg:gap-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="text-lg">Select Camera:</div>
        <div>
          <Input shadow />
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="text-lg">Inspection Input:</div>
        <div>
          <div className="flex gap-4">
            <Radio  label="Continous"/>
            <Radio  label="On Trigger"/>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="text-lg">Select Trigger:</div>
        <div>
          <Select/>
        </div>
      </div>
